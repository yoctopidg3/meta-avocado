...
# Add original meta-qt5 location to search paths
FILESEXTRAPATHS:prepend := "${@':'.join(['%s/recipes-qt/qt5/qtwebengine' % layer for layer in d.getVar('BBLAYERS').split() if 'meta-qt5' in layer])}:"
